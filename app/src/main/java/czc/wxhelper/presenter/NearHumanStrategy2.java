...
import czc.wxhelper.model.SentenceModel;
import czc.wxhelper.model.WechatFriendModel;
import czc.wxhelper.model.WechatFriendModelDao;

import static czc.wxhelper.util.NodeUtil.checkNodeDes;
import static czc.wxhelper.util.NodeUtil.checkNodeText;
import static czc.wxhelper.util.NodeUtil.findNodeByIdAndClassName;
import static czc.wxhelper.util.NodeUtil.findNodeByIdAndClassNameList;
import static czc.wxhelper.util.NodeUtil.findNodeByIdAndText;
import static czc.wxhelper.util.NodeUtil.findNodeByIdClassAndClick;
import static czc.wxhelper.util.NodeUtil.findNodeByIdTextAndClick;
import static czc.wxhelper.util.NodeUtil.findNodeByTextAndClick;
import static czc.wxhelper.util.NodeUtil.performClick;
import static czc.wxhelper.util.NodeUtil.performScroll;
import static czc.wxhelper.util.NodeUtil.sleep;
import static czc.wxhelper.util.NodeUtil.traverseNodeByClassList;

/**
 * Created by alan on 2017/7/4.
 * 自动加附近的人
 */
