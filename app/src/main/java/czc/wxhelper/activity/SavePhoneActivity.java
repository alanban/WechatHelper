...
import czc.wxhelper.presenter.CreateNumberPresenter;
 ...
 * 生成号码
 */
public class SavePhoneActivity extends BaseActivity implements CreatePhoneView {
    ...
    protected void initData() {
        mController = new CreateNumberPresenter(this,this);
